...
import 'package:payme/app/orders/presentation/new_order/basket_screen.dart';
...
import 'package:payme/app/products/presentation/product_search_screen.dart';
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () async {
              context.push(ProductSearchScreen());
            },
          ),
          IconButton(
